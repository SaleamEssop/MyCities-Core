<template>
  <AdminLayout>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Advertising</h1>
      <a :href="route('ads.landing-settings')" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        <i class="fas fa-cog fa-sm text-white-50"></i> Landing Settings
      </a>
    </div>
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Ads List</h6>
      </div>
      <div class="card-body">
          ...
          <table class="table table-bordered" width="100%">
            ...
            <tbody>
              <tr v-for="ad in ads" :key="ad.id">
                ...
                <td>
                  <a :href="`/admin/ads/edit/${ad.id}`" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                </td>
              </tr>
...
const props = defineProps({ ads: { type: Array, default: () => [] } })
